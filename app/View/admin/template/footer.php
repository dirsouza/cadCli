    ...
    <script src="/lib/datatables/extensions/responsive/js/dataTables.responsive.min.js"></script>
    <script src="/lib/datatables/extensions/responsive/js/responsive.bootstrap.js"></script>
    <!-- jQuery Validate -->
